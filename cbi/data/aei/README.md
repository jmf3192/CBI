...
- `aei_concesiones_base_v4.csv`: histórico de concesiones definitivo, actualizado con las puntuaciones que se han podido conciliar en propuestas provisionales. Incorpora 418 expedientes publicados en las resoluciones finales de 2013 y 2014 (223 y 195, respectivamente). Incluye también las 51 propuestas aprobadas provisionalmente de 2026; la interfaz las sustituye por el detalle completo de solicitudes de 2026 para no duplicarlas.
